...
* [**1-create-clean-demographics-notebook**.ipynb](Notebooks/1-create-clean-demographics-notebook.md) \[code: [.ipynb](Code/notebooks/1-create-clean-demographics-noteook.ipynb) | [.py](Code/python_scripts/1-create-clean-demographics-notebook.py)\] 
